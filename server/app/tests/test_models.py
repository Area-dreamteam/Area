...
class TestUserModel:
    ...
    def test_user_model_unicode_handling(self):
        ...
        user_data = {"name": "测试用户 éñ 🚀", "email": "test@example.com"}
...
class TestReactionModel:
    ...
    def test_reaction_model_with_config_schema(self):
        ...
        reaction = Reaction(
            service_id=1, name="Configured Reaction", config_schema=config_schema
        )
...
class TestOAuthLoginModel:
    ...
    def test_oauth_login_model_creation(self):
        ...
        oauth_data = {"name": "github", "image_url": "github.png", "color": "#000000"}
...
class TestServiceSchemas:
    ...
    def test_create_area_action_schema(self):
        ...
        action_data = {"action_id": 1, "config": {"webhook_url": "https://example.com"}}
    ...
    def test_create_area_reaction_schema(self):
        ...
        reaction_data = {"reaction_id": 1, "config": {"message": "Hello World"}}
...
class TestModelValidationEdgeCases:
    ...
    def test_json_field_validation(self):
        ...
        action = Action(
            service_id=1, name="Test", interval=60, config_schema=valid_schema
        )
