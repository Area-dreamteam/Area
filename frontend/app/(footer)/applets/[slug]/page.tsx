...
import { fetchApplets, fetchSpecificApplet, fetchCopyApplet } from '@/app/functions/fetch';
        ...
        <div>
            {loading ? (
                ...
                <div className="w-screen">
                    <div className="grid grid-cols-4 text-white md:h-[500px] h-[300px]" style={{ background: applet.area_info.color }}>
                        ...
                        <div className="flex flex-col mt-[50px] text-[35px] mb-[20px] font-bold col-span-2 mx-auto w-[100%]">
                            ...
                            <button className="my-[35%] little-rounded-button centered w-[60%]" onClick={() => copyApplet(applet.area_info.id)}>
                                Copy
                            </button>
                        </div>
