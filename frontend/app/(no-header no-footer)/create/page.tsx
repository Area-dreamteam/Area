      ...
      {validating ? (
        <div>
          ...
          <div className="flex justify-center mt-[30px]">
            <Button className="rounded-full border-black text-white hover:bg-black bg-black border-[4px] hover:cursor-pointer px-[30px] py-[20px] font-bold w-[250px] h-[100px] text-[30px]" onClick={() => action && reaction && createApplet(action, reaction, title, actConfig, reactConfig)} disabled={title === "" || !action || !reaction}>
              Finish
            </Button>
          </div>
        </div>
