...
import { AppletRespSchema } from "@/app/types/applet"
...
interface CreationProps {
  ...
  setAppletRespSchema?: (arg: AppletRespSchema) => void
}
...
function makeAppletResponse(setAppletRespSchema: (arg: AppletRespSchema) => void, title: string, description: string, action: ActDetails, reactions: ActDetails[])
{
    ...
    setAppletRespSchema(response);
}

function Creation({ creating, setAppletRespSchema = () => "",  theAction, setTheAction, theReactions, setTheReactions, 
...
interface ManagementProp {
    creating: boolean,
    theAction: ActDetails | null,
    setTheAction: (arg: ActDetails | null) => void,
    theReactions: ActDetails[] | null,
    setTheReactions: (arg: ActDetails[] | null) => void,
    setAppletRespSchema?: (arg: AppletRespSchema) => void
}

export default function AppletManagement({ creating, theAction, setTheAction,
    theReactions, setTheReactions, setAppletRespSchema}: ManagementProp)
  {
    ...
    return (
      <div>
        {(!choosingAction && !choosingReaction) &&
          <Creation
            creating={creating}
            setAppletRespSchema={setAppletRespSchema}
            theAction={theAction}
