...
export default function forgotPassword()
{
    return (
        <div>
            <h1 className="flex justify-center text-[50px] text-black mb-10 font-bold mt-[50px]">Forgot your password ?</h1>
            <div className="flex justify-center">
                ...
                <p className="flex justify-center text-[20px] mb-[30px]">
