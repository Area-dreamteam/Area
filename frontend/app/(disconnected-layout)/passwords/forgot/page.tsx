...
export default function forgotPassword() {
  return (
    <div>
      <h1 className="centered text-[50px] text-black mb-10 font-bold mt-[50px]">
        Forgot your password ?
      </h1>
      <div className="centered">
        <Input
          type="email"
          className="text-black h-[50px] w-[500px] pl-2 mb-[20px] border-[4px] rounded-xl placeholder:text-[20px] placeholder:font-bold"
